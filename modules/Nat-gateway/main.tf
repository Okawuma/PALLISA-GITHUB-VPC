...
resource "aws_eip" "eip_for_nat_gateway_az1" {
  ...
  tags   = {
    Name = "pallisa-nat-gateway-az1-eip"
  }
}
...
resource "aws_eip" "eip_for_nat_gateway_az2" {
  ...
  tags   = {
    Name = "pallisa-nat-gateway-az2-eip"
  }
}
...
resource "aws_nat_gateway" "nat_gateway_az1" {
  ...
  tags   = {
    Name = "pallisa-nat-gateway-az1"
  }

  # to ensure proper ordering, it is recommended to add an explicit dependency,ie internet-gateway.
...
resource "aws_route_table" "private_route_table_az1" {
  ...
  tags   = {
    Name = "pallisa-private-routetable.az1"
  }
}
